...
%2 = cbde.unknown : none loc("C:\\Users\\cognizantdotnet31\\source\\repos\\SchoolSystem\\BusinessService\\BusinessService.Data\\Repositories\\GenericRepository.cs" :39 :12) // this._DbSet (SimpleMemberAccessExpression)
%3 = cbde.unknown : none loc("C:\\Users\\cognizantdotnet31\\source\\repos\\SchoolSystem\\BusinessService\\BusinessService.Data\\Repositories\\GenericRepository.cs" :39 :31) // Not a variable of known type: entity
%4 = cbde.unknown : none loc("C:\\Users\\cognizantdotnet31\\source\\repos\\SchoolSystem\\BusinessService\\BusinessService.Data\\Repositories\\GenericRepository.cs" :39 :12) // this._DbSet.Attach(entity) (InvocationExpression)
%5 = cbde.unknown : none loc("C:\\Users\\cognizantdotnet31\\source\\repos\\SchoolSystem\\BusinessService\\BusinessService.Data\\Repositories\\GenericRepository.cs" :40 :12) // this (ThisExpression)
%6 = cbde.unknown : none loc("C:\\Users\\cognizantdotnet31\\source\\repos\\SchoolSystem\\BusinessService\\BusinessService.Data\\Repositories\\GenericRepository.cs" :40 :12) // this._DbContext (SimpleMemberAccessExpression)
%7 = cbde.unknown : none loc("C:\\Users\\cognizantdotnet31\\source\\repos\\SchoolSystem\\BusinessService\\BusinessService.Data\\Repositories\\GenericRepository.cs" :40 :34) // Not a variable of known type: entity
%8 = cbde.unknown : none loc("C:\\Users\\cognizantdotnet31\\source\\repos\\SchoolSystem\\BusinessService\\BusinessService.Data\\Repositories\\GenericRepository.cs" :40 :12) // this._DbContext.Entry(entity) (InvocationExpression)
%9 = cbde.unknown : none loc("C:\\Users\\cognizantdotnet31\\source\\repos\\SchoolSystem\\BusinessService\\BusinessService.Data\\Repositories\\GenericRepository.cs" :40 :12) // this._DbContext.Entry(entity).State (SimpleMemberAccessExpression)
// Entity from another assembly: EntityState
%10 = cbde.unknown : none loc("C:\\Users\\cognizantdotnet31\\source\\repos\\SchoolSystem\\BusinessService\\BusinessService.Data\\Repositories\\GenericRepository.cs" :40 :50) // EntityState.Modified (SimpleMemberAccessExpression)
br ^1
